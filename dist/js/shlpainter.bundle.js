...
var DisplayObject = function (_EventDispatcher) {
	...
	function DisplayObject() {
		...
		_this.divObject = document.createElement("div");
		_this.divObject.className = "dispaly-object";
		...
		_this._scaleY = 1;
		_this._rotation = 0;
		_this._backgroundColor = "transparent";
		_this._opacity = 1;
		_this.parent = null;
		return _this;
	}
	...
	_createClass(DisplayObject, [{
		...
		key: "setDivObject",
		value: function setDivObject(pdo) {
			this.divObject = pdo;
			this.divObject.className = "dispaly-object";
		}
	}, {
		key: "setMask",
		value: function setMask(px, py, pw, ph, purl) {
...
var _DisplayObject2 = __webpack_require__(0);
...
var Container = function (_DisplayObject) {
	...
	function Container() {
		...
		_this.divObject.setAttribute("name", "container");
		_this.children = [];
		return _this;
	}
	...
	_createClass(Container, [{
		...
		key: "_deleteEmptyNode",
		value: function _deleteEmptyNode() {
...
var EventDispatcher = function () {
	...
	_createClass(EventDispatcher, [{
		...
		value: function on(type, listener, scope, once, data, useCapture) {
			...
			scope = scope || this;
			return addEventListener(type, function (evt) {
		...
		value: function dispatchEvent(eventObj, bubbles, cancelable) {
			if (typeof eventObj == "string") {
				var listeners = this._captureListeners;
		...
		value: function _dispatchEvent(eventObj, eventPhase) {
			...
			if (eventObj && listeners) {
				var _arr = listeners[eventObj.type];
				if (!_arr || !(l = _arr.length)) {
					return;
				}
				try {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js!./shlpainter.css", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js!./shlpainter.css");
...
var ImageObject = function (_DisplayObject) {
	_inherits(ImageObject, _DisplayObject);

	function ImageObject(purl) {
		...
		_this.setDivObject(document.createElement("img"));
		_this.divObject.className = "image-object";
		_this.divObject.setAttribute("name", "imageObject");
		_this.setImage(purl);
		return _this;
	}
...
var Stage = function (_Container) {
	...
	function Stage(div, viewwidth, viewheight) {
		...
		_this.setDivObject(div);
		_this.divObject.style.position = "relative";
		_this.divObject.setAttribute("name", "stage");
...
// module
exports.push([module.i, ".dispaly-object{\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\ttransform-origin: center;\r\n\tmask-repeat: no-repeat;\r\n\toverflow: hidden;\r\n}\r\n.image-object{\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\ttransform-origin: center;\r\n\twidth: auto;\r\n\theight: auto;\r\n\tmask-repeat: no-repeat;\r\n}", ""]);
...
var _DisplayObject = __webpack_require__(0);
...
window.shlpainter = window.shlpainter || {};
window.shlpainter.Event = _Event2.default;
window.shlpainter.EventDispatcher = _EventDispatcher2.default;
window.shlpainter.DisplayObject = _DisplayObject2.default;
window.shlpainter.Container = _Container2.default;
window.shlpainter.Shape = _Shape2.default;
window.shlpainter.ImageObject = _ImageObject2.default;
window.shlpainter.Stage = _Stage2.default;
